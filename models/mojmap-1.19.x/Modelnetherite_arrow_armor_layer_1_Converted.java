...
public class Modelnetherite_arrow_armor_layer_1_Converted<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "netherite_arrow_armor_layer_1_converted"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(16, 16)
						.addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.75F)).texOffs(0, 32)
		...
		PartDefinition cube_r1 = bone12.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(57, 17).addBox(10.25F, -20.5F, 2.75F, 3.0F, 12.0F, 3.0F,
		...
		PartDefinition bone = bone11.addOrReplaceChild("bone", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition bone2 = bone.addOrReplaceChild("bone2", CubeListBuilder.create(),
				PartPose.offset(0.25F, 24.0F, -1.5F));

		PartDefinition cube_r2 = bone2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(87, 0)
						.addBox(12.25F, -22.0F, 5.25F, 0.5F, 0.0F, 0.5F, new CubeDeformation(0.0F)).texOffs(88, 1)
						.addBox(12.25F, -22.5F, 5.5F, 0.5F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone4 = bone.addOrReplaceChild("bone4", CubeListBuilder.create(),
				PartPose.offset(0.75F, 24.5F, -0.75F));

		PartDefinition cube_r3 = bone4.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(87, 0)
						.addBox(12.25F, -22.0F, 5.25F, 0.5F, 0.0F, 0.5F, new CubeDeformation(0.0F)).texOffs(86, 1)
						.addBox(12.45F, -23.25F, 4.5F, 0.0F, 2.0F, 0.5F, new CubeDeformation(0.0F)).texOffs(86, 1)
						.addBox(12.5F, -22.5F, 5.25F, 0.0F, 2.0F, 0.5F, new CubeDeformation(0.0F)).texOffs(87, 2)
						.addBox(12.25F, -22.5F, 5.5F, 0.5F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.6981F));

		PartDefinition bone3 = bone.addOrReplaceChild("bone3", CubeListBuilder.create(),
				PartPose.offset(-0.25F, 24.75F, -0.25F));

		PartDefinition cube_r4 = bone3.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(87, 0)
						.addBox(12.25F, -22.0F, 5.25F, 0.5F, 0.0F, 0.5F, new CubeDeformation(0.0F)).texOffs(87, 0)
						.addBox(12.5F, -22.5F, 5.25F, 0.0F, 2.0F, 0.5F, new CubeDeformation(0.0F)).texOffs(88, 1)
						.addBox(12.25F, -22.5F, 5.5F, 0.5F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.6981F));

		PartDefinition bone5 = bone.addOrReplaceChild("bone5", CubeListBuilder.create(),
				PartPose.offset(-0.75F, 25.75F, -2.0F));
		...
		PartDefinition bone9 = bone.addOrReplaceChild("bone9", CubeListBuilder.create(),
				PartPose.offset(-0.5F, 25.5F, -1.0F));
		...
		PartDefinition bone10 = bone.addOrReplaceChild("bone10", CubeListBuilder.create(),
				PartPose.offset(-0.75F, 25.5F, -0.5F));
		...
		PartDefinition bone6 = bone.addOrReplaceChild("bone6", CubeListBuilder.create(),
				PartPose.offset(-0.25F, 24.25F, -1.25F));
		...
		PartDefinition bone7 = bone.addOrReplaceChild("bone7", CubeListBuilder.create(),
				PartPose.offset(-0.5F, 25.0F, -2.25F));
		...
		PartDefinition bone8 = bone.addOrReplaceChild("bone8", CubeListBuilder.create(),
				PartPose.offset(0.0F, 25.25F, -1.5F));

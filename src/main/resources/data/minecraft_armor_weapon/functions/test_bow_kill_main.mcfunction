...
# ③の処理
#########################################################
execute store result score @s AS2_X0 run data get entity @s Pos[0] 1500
execute store result score @s AS2_Y0 run data get entity @s Pos[1] 1500
execute store result score @s AS2_Z0 run data get entity @s Pos[2] 1500
#########################################################
...
# ④の処理
#########################################################
execute store result score @s AS2_X1 run data get entity @e[tag=AS2_AEC,limit=1] Pos[0] 1500
execute store result score @s AS2_Y1 run data get entity @e[tag=AS2_AEC,limit=1] Pos[1] 1500
execute store result score @s AS2_Z1 run data get entity @e[tag=AS2_AEC,limit=1] Pos[2] 1500
#########################################################

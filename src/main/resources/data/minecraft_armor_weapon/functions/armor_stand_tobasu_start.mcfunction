...
execute anchored eyes as @e[tag=minecraft_armor_weapon_armor_stand_tobasu_main_AS2_INI,limit=1,sort=nearest] run effect give @s minecraft_armor_weapon:armor_stand_tobasu_effect 2 1 true
#########################################################

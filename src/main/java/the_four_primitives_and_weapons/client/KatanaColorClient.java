...
public class KatanaColorClient {
	...
	public static void registerItemColors(RegisterColorHandlersEvent.Item event) {
		event.register((stack, tintIndex) -> {
			...
			if (tintIndex == 7) return 0xFF000000 | KatanaFittings.bladeShadeRgb(stack);
			...
			switch (tintIndex) {
				case 1: return KatanaFittings.fittingTint(stack, 1, KatanaFittings.tsukaRgb(stack));
				case 2: return KatanaFittings.fittingTint(stack, 2, KatanaFittings.tsubaRgb(stack));

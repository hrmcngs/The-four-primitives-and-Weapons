...
public class RpgBookGui2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public RpgBookGui2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinecraftArmorWeaponModMenus.RPG_BOOK_GUI_2.get(), id);

...
import minecraftarmorweapon.procedures.CometKillenteiteigaSiWangsitaShiProcedure;

import minecraftarmorweapon.init.MinecraftArmorWeaponModEntities;

public class CometKillEntity extends PathfinderMob {
	public CometKillEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MinecraftArmorWeaponModEntities.COMET_KILL.get(), world);
	}

	public CometKillEntity(EntityType<CometKillEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0f;
		xpReward = 0;
		setNoAi(false);

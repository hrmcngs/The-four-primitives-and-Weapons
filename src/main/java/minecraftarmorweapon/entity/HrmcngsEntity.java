...
public class HrmcngsEntity extends Villager {
	public HrmcngsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MinecraftArmorWeaponModEntities.HRMCNGS.get(), world);
	}

	public HrmcngsEntity(EntityType<HrmcngsEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);

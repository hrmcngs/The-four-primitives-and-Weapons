...
import minecraftarmorweapon.procedures.CometenteiteinotitukuGengXinShiProcedure;

import minecraftarmorweapon.init.MinecraftArmorWeaponModEntities;

public class CometEntity extends PathfinderMob {
	public CometEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MinecraftArmorWeaponModEntities.COMET.get(), world);
	}

	public CometEntity(EntityType<CometEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0f;
		xpReward = 0;
		setNoAi(false);

...
public class MinecraftArmorWeaponModVillagerProfessions {
	...
	public static final RegistryObject<VillagerProfession> ARMOR_AND_WEAPON_VILLAGERS_POSITION = registerProfession("armor_and_weapon_villagers_position", () -> Blocks.ENCHANTING_TABLE,

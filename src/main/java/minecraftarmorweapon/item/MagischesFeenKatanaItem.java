...
import minecraftarmorweapon.procedures.MyMagicKatanaYoukuritukusitatokiProcedure;
import minecraftarmorweapon.procedures.MagischesFeenKatanamobugaturudeGongJisaretatokiProcedure;
import minecraftarmorweapon.procedures.IronKatanaturuwoShoudeChituteiruJiannoteitukuProcedure;

import minecraftarmorweapon.init.MinecraftArmorWeaponModTabs;

public class MagischesFeenKatanaItem extends SwordItem {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		MagischesFeenKatanamobugaturudeGongJisaretatokiProcedure.execute(entity, sourceentity);
		return retval;
	}

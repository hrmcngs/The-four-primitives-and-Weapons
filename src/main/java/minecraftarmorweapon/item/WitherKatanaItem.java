...
import minecraftarmorweapon.procedures.WitherKatanaYoukuritukusitatokiProcedure;
...
public class WitherKatanaItem extends SwordItem {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		WitherKatanaYoukuritukusitatokiProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity);
		return ar;
	}

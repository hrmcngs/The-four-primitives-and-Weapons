...
public abstract class DragonBlueArmorItem extends ArmorItem {
	public DragonBlueArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends DragonBlueArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "minecraft_armor_weapon:textures/entities/doragon_leprica_blue_helmet_3d.png";
		}
	}

	public static class Chestplate extends DragonBlueArmorItem {
		public Chestplate() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "minecraft_armor_weapon:textures/models/armor/doragon_leprica_blue_armor__layer_1.png";
		}
	}

	public static class Leggings extends DragonBlueArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "minecraft_armor_weapon:textures/models/armor/doragon_leprica_blue_armor__layer_2.png";
		}
	}

	public static class Boots extends DragonBlueArmorItem {
		public Boots() {

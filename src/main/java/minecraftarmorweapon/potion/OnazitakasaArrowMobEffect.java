...
public class OnazitakasaArrowMobEffect extends MobEffect {
	...
	public String getDescriptionId() {
		return "effect.minecraft_armor_weapon.onazitakasa_arrow";
	}

	@Override
	public void addAttributeModifiers(LivingEntity entity, AttributeMap attributeMap, int amplifier) {
		OnazitakasaArrowposiyonnoXiaoGuogaKaiShiShiYongsaretatokiProcedure.execute(entity.getX(), entity.getY(), entity.getZ(), entity);
	}

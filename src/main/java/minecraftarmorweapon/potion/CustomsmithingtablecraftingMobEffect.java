...
public class CustomsmithingtablecraftingMobEffect extends MobEffect {
	...
	public String getDescriptionId() {
		return "effect.minecraft_armor_weapon.customsmithingtablecrafting";
	}

	@Override
	public void addAttributeModifiers(LivingEntity entity, AttributeMap attributeMap, int amplifier) {
		CustomsmithingtablecraftingposiyonnoXiaoGuogaKaiShiShiYongsaretatokiProcedure.execute(entity);
	}

	@Override
	public void removeAttributeModifiers(LivingEntity entity, AttributeMap attributeMap, int amplifier) {
		super.removeAttributeModifiers(entity, attributeMap, amplifier);
		CustomsmithingtablecraftingposiyonXiaoGuogaQieretaShiProcedure.execute(entity);
	}

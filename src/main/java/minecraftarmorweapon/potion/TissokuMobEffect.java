...
public class TissokuMobEffect extends MobEffect {
	public TissokuMobEffect() {
		super(MobEffectCategory.NEUTRAL, -16768257);
	}

	@Override
	public String getDescriptionId() {
		return "effect.minecraft_armor_weapon.tissoku";
	}

package net.mcreator.minecraftarmorweapon.network;
...
public class MinecraftArmorWeaponModVariables {
	...
	public static class PlayerVariables {
		public double ggg = 2.0;
		public String aaa = "lllll";
		...
		public Tag writeNBT() {
			...
			nbt.putDouble("ggg", ggg);
			nbt.putString("aaa", aaa);
			return nbt;
		}

		public void readNBT(Tag Tag) {
			CompoundTag nbt = (CompoundTag) Tag;
			ggg = nbt.getDouble("ggg");
			aaa = nbt.getString("aaa");
		}
	}
		...
		public static void handler(PlayerVariablesSyncMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
			...
			context.enqueueWork(() -> {
				if (!context.getDirection().getReceptionSide().isServer()) {
					...
					variables.ggg = message.data.ggg;

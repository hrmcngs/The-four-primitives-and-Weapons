 ...
 *
 */
package net.mcreator.minecraftarmorweapon;
...
public class MinecraftArmorWeaponMod {
	public static final Logger LOGGER = LogManager.getLogger(MinecraftArmorWeaponMod.class);
	public static final String MODID = "minecraft_armor_weapon";

...
#
# 質問を省略する例:
#   WITH_EXTERNAL_MODS=1 PERFORMANCE_ONLY_MODS=1 bash run_client_mac.sh  # Embeddium + Oculus + extra_video_settings / VanillaLite
#   WITH_EXTERNAL_MODS=1 LIGHT_EXTERNAL_MODS=1 bash run_client_mac.sh offline  # 追加2MODも有効
